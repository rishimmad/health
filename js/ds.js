 ...
 */
var userId = "1703409";//102978,"1703409";2089714654,1910552(duplicates)
var siteInfo = null;
var productList = [];
...
function populatePage(){
    ...
    if(productList.length>0){
        for (var i = 0; i < productList.length; i++) {
            ...
            divProducts += '<div class="row"><div class="about-description"><img alt="image" class="product_img span3" src="' +
            productList[i].imageurl + '"><a onclick="storeProductId('
    ...
    if (productId != null && productList.length>0) {
        ...
        for (var i = 0; i < productList.length; i++) {
            if (productList[i].id == productId) {
                ...
                productList[i].imageurl + '"><a onclick="loadData('
    ...
    if(cityCount > 0){
        for (var i = 0; i < siteInfo.results.aggregations.city.buckets.length; i++) {
            ...
            cities += '<option value="' + siteInfo.results.aggregations.city.buckets[i].key + '">' + siteInfo.results.aggregations.city.buckets[i].key;
        }
